# GEMINI.md — <nome progetto>

> **Template v0.4 (variante Gemini/Antigravity).** Regole **operative** per l'agente.
> Gemella di `CLAUDE.md`: stesse regole, adattata all'ecosistema Google.
...
> il razionale di una regola. `METHOD.md` è la **fonte di verità** ed è **STABILE**:
> non modificarlo senza **approvazione esplicita** dell'utente.
>
> **Precedenza Antigravity**: `GEMINI.md` > `AGENTS.md` > `.agent/rules/`. Se in
> questo progetto esiste un `AGENTS.md` condiviso cross-tool, questo file lo
> **integra**, non lo duplica.
...
- **Committa solo a Gate verde**, con messaggio (cosa + perché).
